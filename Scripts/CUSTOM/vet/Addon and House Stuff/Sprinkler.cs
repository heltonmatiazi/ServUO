...
namespace Server.Items
{
    ...
    public class Sprinkler : Item, ISecurable, IRewardItem
	{
	...
	public class SprinklerSystem : Bag
   {
      [Constructable]
      public SprinklerSystem() : this( 1 )
      {
        Movable = true;
        //Hue = 0x386;
      ...
      [Constructable]
      public SprinklerSystem( int amount )
      {
         DropItem( new Sprinkler() );
         DropItem( new SprinklerContainer() );
      }


      public SprinklerSystem( Serial serial ) : base( serial )
      {
      }
