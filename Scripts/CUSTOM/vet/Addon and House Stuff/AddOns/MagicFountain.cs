...
{
   public class MagicFountainAddon : BaseAddon, IWaterSource//, IChopable
   {
       public override BaseAddonDeed Deed{ get{ return new MagicFountainDeed(); } }
      public int Quantity
      {
         get{ return 500; }
         set{}
      ...
      public MagicFountainAddon()
      {
         ...
         // ... damnit wasn't there an easier way to do this?
         int i = Utility.RandomMinMax( 1, 5 );
         switch( i )
         {
...
/*public void OnChop( Mobile from )
		{
                       MagicFountainDeed deed = new MagicFountainDeed();
			if ( from != null )
   ...
   public class MagicFountainPiece : AddonComponent//, IChopable
   {
      ...
      public override void OnDoubleClick( Mobile from )
      {
         if ( from.InRange( m_Fountain.GetWorldLocation(), 4 ) )
         {
            ...
            else
            {
               ...
               //MagicFountainAddon m = (MagicFountainAddon)this.Parent;
               ...
               if ( 0.1 > Utility.RandomDouble() )
               {
                  ...
                  {
                     case MagicFountainAddon.FountainMessage.Cool:  msg = "You drink your fill of the cool fountain water. The sound of the water splashing is musical.";         from.Hits += 10; break;
                     case MagicFountainAddon.FountainMessage.Warm:  msg = "The fountain's warm water refreshes you and sets your mind at ease. You drink your fill.";         from.Stam += 10; break;
                     ...
                     case MagicFountainAddon.FountainMessage.Calm:  msg = "As you drink from the water, a scent reminds you of memories long forgotten.";               from.Mana += 10; break;
                     case MagicFountainAddon.FountainMessage.Fruit: msg = "The fountain's water tastes vaguely of a fruit you can't identify. You drink your fill.";         from.Stam += 10; break;
                  }
      ...
      public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list )
      {
         ...
         //MagicFountainAddon m = (MagicFountainAddon)this.Parent;
         if ( m_Fountain != null && from.InRange( m_Fountain.GetWorldLocation(), 2 ) && m_Fountain.Magic )
      ...
      private class ActivateEntry : ContextMenuEntry
      {
         ...
         {
            if ( m_From.InRange( m_Fountain.GetWorldLocation(), 2 ) )
            {
                  ...
                  switch( m_Fountain.MessageNum )
                  {
                     ...
                     case MagicFountainAddon.FountainMessage.Clean: {
                        if ( 0.05 > Utility.RandomDouble() )
                        {
                           ...
                           switch( Utility.RandomMinMax( 1, 10 ) )
                           {
                              case 1:  food = new Apple();   break; // fixed for b36 default dist
                              ...
                              case 9:  food = new Peach();      break; // fixed for b36 default dist
                              case 10: food = new Apple();   break; // fixed for b36 default dist
                           }
   ...
   public class MagicFountainDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return new MagicFountainAddon(); } }

		[Constructable]
		public MagicFountainDeed()
		{
                  Name = "a magic fountain deed";
                  Weight = 1.0;
		}

		public MagicFountainDeed( Serial serial ) : base( serial )
		{
		}
